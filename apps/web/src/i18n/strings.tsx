...
The skill it installs is the same one published at ${skillUrl}.`,
    ...
    copyGate: "Create a token above first. This text carries a token, so right now there is only a placeholder to copy.",
...
它装的 skill 就是 ${skillUrl} 这一份。`,
    ...
    copyGate: "先在上面创建 token。这段内容里带着 token，现在复制到的只是一个占位符。",
